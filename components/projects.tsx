      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mb-32">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-amber-500/20 bg-amber-500/10 text-amber-600 dark:text-amber-400 text-sm font-medium mb-6">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight">
              Currently <span className="text-amber-500">Working On</span>
            </h3>
          </div>

          <div className="max-w-4xl mx-auto">
            {currentProjectData.map((project, index) => (
              <MapRevealCard key={`current-${index}`} className="group flex flex-col h-full min-h-[250px]">
                <Card className="h-full w-full bg-transparent border-0 flex flex-col md:flex-row shadow-none p-0 overflow-hidden">
                  ...
                  <div className="relative w-full md:w-2/5 h-[200px] md:h-auto bg-muted/20 dark:bg-black/40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          ...
          {projectsData.map((project, index) => {
            ...
            const CardComponent = project.useMapReveal ? MapRevealCard : SpotlightCard;
            const cardProps = project.useMapReveal ? { mapImageUrl: project.mapImageUrl } : {};

            return (
              <CardComponent key={index} {...(cardProps as any)} className={`${gridClass} group flex flex-col h-full min-h-[320px]`}>
